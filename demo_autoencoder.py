...
def main(path):
    ...
    generator, kp_detector = load_checkpoints(config_path='checkpoints/fomm/config/vox-adv-256.yaml',
                                              checkpoint_path='checkpoints/fomm/vox-adv-cpk.pth.tar', device='cuda:0')
